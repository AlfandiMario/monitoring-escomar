...
$sql = mysqli_query($konek, "select * from monitoring2 order by id desc"); //data terakhir akan berada diatas
...
<body>
     ...
     <div class="container" style="text-align: center; margin-top: 20px;">
          ...
          <div class="fluid-container">
               <img src="images/icon-escomar.png" style="width: 15%; margin-bottom: 3%;">
          </div>
          ...
          <table class="table table-borderless">
               ...
               <tbody>
                    <tr>
                         ...
                         <th scope="row"> <span><?= $rfid ?></span></th>
